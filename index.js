const authConfig = {
  "siteName": "TallyAll", // WebSite Name
...
// client_id & client_secret - PLEASE USE YOUR OWN!
  "client_id": tallyall_client_id, // Client ID
  "client_secret": tallyall_client_secret, // Client Secret
  "refresh_token": tallyall_client_refresh, // Refresh Token
/**
  ...
  */
  "roots": [
    {
      id: tallyall_gdrive_id, //you can use folderid other than root but then search wont work
      name: "TallyAll",
      user: '',
      pass: '',
...
const uiConfig = {
  ...
  "hide_actions_tab": false, // Set this to true if you want to hide the actions tab which contains direct download, copy link, open in a new tab button
  ...
  "footer_text": "", // // Provide the footer text. Leave this empty if you want to hide it
